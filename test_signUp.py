            ...
            if (execute_next is True):
                try:
                    ...
                    # Delete the testing account
                        # Get the ID of the testing acount
                    testUser_token = get_user_info(self.config, "token", "signUp")
                    testUser_id = get_user_info(self.config, "id", "signUp")
                    print(f"Token is : {testUser_token}\n")
                    print(f"ID is {testUser_id}\n")
                    
                    admin_token = get_user_info(self.config, "token", "admin")
                    admin_id = get_user_info(self.config, "id", "admin")
                    print(f"Token is : {admin_token}\n")
                    print(f"ID is {admin_id}\n")
